	...
	return (
		<div className=' bg-white rounded-lg px-10 p-10 dark:bg-neutral-900'>
			...
			<h2 className='font-semibold text-3xl mb-2'>
				...
				{isGroup || isEdu 
				? <p>თქვენ წარმატებით ჩაეწერეთ ჯგუფში. დამატებით ინფორმაციას მოგაწვდით ანიმუსის მენეჯერი. ჯგუფიდან ამოსაწერად გთხოვთ დაგვიკავშირდეთ ნომერზე: +995 32 2112 144</p>
				: <p>ვიზიტის შესახებ დეტალები გამოგზავნილია თქვენს მიერ მითითებულ ნომერზე, დამატებითი
				ინფორმაციისთვის გთხოვთ დაუკავშირდეთ ანიმუსის ოპერატორს ნომერზე: +995 32 2112 144</p>
			}
