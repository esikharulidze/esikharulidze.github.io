...
const Quizz: FC<ServiceInnerProps> = ({ onSubmit, setAge, setPartner, age, partner, withPartner = false, forElse = false, forMe = false, isPsychiatrist=false, isGroup=false, isEdu=false }) => {
