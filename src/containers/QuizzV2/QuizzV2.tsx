...
const QuizzV2: FC<ServiceInnerProps> = ({ className = "" }) => {
  ...
  return (
    ...
    <div className="grid justify-content-center grid-cols-1 xl:grid-cols-4 md:grid-cols-1 lg:grid-cols-1">
      ...
      <header className="text-center mt-24 mb-10">
        ...
        <h2 className="font-semibold text-2xl mb-4">თქვენი სქესი</h2>
        
                 
        <div className="grid grid-cols-1 gap-2 md:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2">
        <ButtonQuizz className="w-full rounded-lg text-left">ქალი</ButtonQuizz>
        <ButtonQuizz className="w-full rounded-lg text-left">კაცი</ButtonQuizz>
        <ButtonQuizz className="w-full rounded-lg">ტრანსგენდერი</ButtonQuizz>
        <ButtonQuizz className="w-full rounded-lg">არაბინარული</ButtonQuizz>
        <ButtonQuizz className="w-full rounded-lg">სხვა</ButtonQuizz>
        <ButtonQuizz className="w-full rounded-lg">არ მსურს პასუხის გაცემა</ButtonQuizz>
        </div>
        <div className="">
